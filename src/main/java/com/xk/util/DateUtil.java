...
public class DateUtil {
   ...
   //日期大小比较 date1小于date2返回-1，date1大于date2返回1，相等返回0
   public static int getDateCompare(String beginTime ,String endTime){
       Integer before=null;
       SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
       try {
           Date date1 = format.parse(beginTime);
           Date date2 = format.parse(endTime);
           before= date1.compareTo(date2);
       } catch (ParseException e) {
           e.printStackTrace();
       }
       return before;
    ...
    public static void main(String[] args) throws ParseException {
        Integer dateCompare = getDateCompare("2021-08-19", "2021-08-20");
